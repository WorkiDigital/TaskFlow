...
export const mockCapabilities: WhatsAppCapability[] = [
  ...
  {
    id: "fetch_groups",
    label: "Buscar grupos existentes",
    status: "blocked",
    dependsOnConnection: true,
  },
  {
    id: "update_desc",
    label: "Atualizar descrição do grupo",
    status: "blocked",
    dependsOnConnection: true,
  },
  {
  ...
  {
    id: "send_links",
    label: "Enviar mensagens com links",
    status: "blocked",
    dependsOnConnection: true,
  },
  {
    id: "mentions",
    label: "Enviar mensagens com menções",
    status: "blocked",
    dependsOnConnection: true,
  },
  {
    id: "internal_notify",
    label: "Notificar grupo interno",
    status: "blocked",
    dependsOnConnection: true,
  },
  {
    id: "validate_number",
    label: "Validar número WhatsApp",
    status: "blocked",
    dependsOnConnection: true,
  },
  {
    id: "get_members",
    label: "Consultar membros do grupo",
    status: "blocked",
    dependsOnConnection: true,
  },
];
