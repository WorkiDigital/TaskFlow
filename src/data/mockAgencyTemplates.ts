...
export const mockAgencyTemplates: AgencyTemplate[] = [
  {
    ...
    description:
      "Fluxo operacional padrão para setup, planejamento e otimização contínua de campanhas de tráfego pago (Meta Ads e Google Ads).",
    ...
    tasks: [
      {
        ...
        description:
          "Reunião de alinhamento ou envio de formulário para mapear objetivos, verba disponível e principais canais.",
        columnId: "col-t2",
        priority: "high",
      ...
      },
      {
        ...
        description:
          "Instalar e testar tags do Google Analytics, Meta Pixel e API de Conversão no site do cliente.",
        columnId: "col-t2",
        priority: "urgent",
      ...
      },
      {
        ...
        description:
          "Estruturação dos públicos de remarketing, semelhantes (lookalike) e interesses, além da jornada de funil.",
        columnId: "col-t2",
        priority: "medium",
        assigneeRule: { type: "role", value: "Gestor de tráfego", fallback: "manager" },
        relativeDueDate: {
      ...
      },
      {
        ...
        description:
          "Desenvolvimento das headlines, textos principais e roteiros para vídeos rápidos focados em conversão.",
        columnId: "col-t3",
        priority: "high",
      ...
      },
      {
        ...
        description:
          "Criação das imagens estáticas, carrosséis e capas para os vídeos baseados no planejamento de anúncios.",
        columnId: "col-t3",
        priority: "medium",
      ...
      },
      {
        ...
        description:
          "Revisão dos criativos e copys pela gestão do projeto para garantir conformidade com o briefing.",
        columnId: "col-t4",
        priority: "low",
      ...
      },
      {
        ...
        description:
          "Enviar as peças e copys para aprovação do cliente antes de subir as campanhas.",
        columnId: "col-t4",
        priority: "high",
        assigneeRule: { type: "role", value: "Atendimento", fallback: "manager" },
        relativeDueDate: {
      ...
      },
      {
        ...
        description:
          "Subir criativos, copys, linkar públicos e definir verbas no Gerenciador de Anúncios (Facebook / Google).",
        columnId: "col-t1",
        priority: "high",
        assigneeRule: { type: "role", value: "Gestor de tráfego", fallback: "manager" },
        relativeDueDate: {
      ...
      },
      {
        ...
        checklist: [
          {
            id: "chk-t1-10-1",
            title: "Mapear custo por clique (CPC) e custo por mil impressões (CPM)",
          },
      ...
      },
      {
        ...
        description:
          "Agendamento e realização de videoconferência para apresentar as métricas e sugerir melhorias.",
        columnId: "col-t5",
        priority: "high",
        assigneeRule: { type: "role", value: "Atendimento", fallback: "manager" },
        relativeDueDate: {
      ...
      },
      {
        ...
        description:
          "Fazer ajustes finos de lance, desativar criativos saturados e testar novos públicos.",
        columnId: "col-t6",
        priority: "medium",
        assigneeRule: { type: "role", value: "Gestor de tráfego", fallback: "manager" },
        relativeDueDate: {
  ...
  },
  {
    ...
    description:
      "Processo completo para lançamentos de infoprodutos (Fórmula de Lançamento / Lançamento Interno). Do kickoff à abertura do carrinho.",
    category: "launch",
    status: "active",
    ...
    tasks: [
      {
        ...
        description:
          "Reunião estratégica com especialista para alinhar promessa, datas e modelo de funil.",
        columnId: "col-l1",
        priority: "high",
        assigneeRule: { type: "role", value: "Gestor de projeto", fallback: "manager" },
        relativeDueDate: {
        ...
        checklist: [
          {
            id: "chk-t2-1-1",
            title: "Validar calendário das datas de captação, aquecimento e abertura",
          },
      ...
      },
      {
        ...
        description:
          "Pesquisar o público, desenhar a persona principal e estruturar a oferta irresistível com bônus.",
        columnId: "col-l2",
        priority: "high",
        assigneeRule: { type: "role", value: "Copywriter", fallback: "manager" },
        relativeDueDate: {
      ...
      },
      {
        ...
        description:
          "Escrever os roteiros completos para os 3 vídeos de conteúdo de pré-lançamento ou roteiro do webinário.",
        columnId: "col-l2",
        priority: "high",
        assigneeRule: { type: "role", value: "Copywriter", fallback: "manager" },
        relativeDueDate: {
      ...
      },
      {
        ...
        description:
          "Inserir cortes, legendas dinâmicas, trilha sonora e imagens de apoio para reter atenção.",
        columnId: "col-l3",
        priority: "medium",
      ...
      },
      {
        ...
        description:
          "Criar as tags de leads, lista do evento e cadastrar a sequência automatizada de e-mails.",
        columnId: "col-l4",
        priority: "high",
        assigneeRule: { type: "role", value: "Gestor de projeto", fallback: "manager" },
        relativeDueDate: {
      ...
      },
      {
        ...
        description:
          "Gerar o pixel da Hotmart/Kiwify, instalar na página de vendas e mapear eventos de InitiateCheckout.",
        columnId: "col-l4",
        priority: "high",
        assigneeRule: { type: "role", value: "Desenvolvedor", fallback: "manager" },
        relativeDueDate: {
      ...
      },
      {
        ...
        description:
          "Colocar os criativos de captação no ar visando acumular leads na página de captura.",
        columnId: "col-l5",
        priority: "high",
        assigneeRule: { type: "role", value: "Gestor de tráfego", fallback: "manager" },
        relativeDueDate: {
      ...
      },
      {
        ...
        description:
          "Monitorar e disparar os e-mails e mensagens de WhatsApp de contagem regressiva para o evento.",
        columnId: "col-l5",
        priority: "high",
        assigneeRule: { type: "role", value: "Gestor de projeto", fallback: "manager" },
        relativeDueDate: {
      ...
      },
      {
        ...
        description:
          "Ativação dos links de checkout, disparo do e-mail de vendas e suporte aos compradores na página de checkout.",
        columnId: "col-l6",
        priority: "urgent",
        assigneeRule: { type: "role", value: "Atendimento", fallback: "manager" },
        relativeDueDate: {
  ...
  },
  {
    ...
    description:
      "Gerenciamento completo de redes sociais: pauta, redação, design, aprovação do cliente e agendamento de postagens.",
    ...
    tasks: [
      {
        ...
        description:
          "Reunião com o cliente para levantar temas que serão abordados no mês e datas comemorativas.",
        columnId: "col-s2",
        priority: "high",
      ...
      },
      {
        ...
        description:
          "Preencher a planilha de planejamento com os títulos das postagens, formatos (carrossel, reels, feed) e datas.",
        columnId: "col-s2",
        priority: "medium",
        assigneeRule: { type: "role", value: "Social Media", fallback: "manager" },
        relativeDueDate: {
      ...
      },
      {
        ...
        description:
          "Redação das legendas de todas as publicações, hashtags e chamadas de ação (CTA).",
        columnId: "col-s2",
        priority: "medium",
        assigneeRule: { type: "role", value: "Social Media", fallback: "manager" },
        relativeDueDate: {
      ...
      },
      {
        ...
        description:
          "Design gráfico dos carrosséis, posts em imagem única e infográficos no Illustrator ou Canva.",
        columnId: "col-s3",
        priority: "high",
        assigneeRule: { type: "role", value: "Designer", fallback: "manager" },
        relativeDueDate: {
      ...
      },
      {
        ...
        description:
          "Fazer cortes, adicionar efeitos, música em alta e transições nos vídeos curtos enviados pelo cliente.",
        columnId: "col-s3",
        priority: "medium",
        assigneeRule: { type: "role", value: "Editor de vídeo", fallback: "manager" },
        relativeDueDate: {
      ...
      },
      {
        ...
        description:
          "Revisão ortográfica e de design de todas as peças e copys antes do envio ao cliente.",
        columnId: "col-s4",
        priority: "low",
        assigneeRule: { type: "role", value: "Gestor de projeto", fallback: "manager" },
        relativeDueDate: {
        ...
        checklist: [{ id: "chk-t3-6-1", title: "Verificar se o design condiz com a pauta" }],
      ...
      },
      {
        ...
        checklist: [{ id: "chk-t3-7-1", title: "Notificar cliente via e-mail e whatsapp" }],
      ...
      },
      {
        ...
        description:
          "Fazer alterações nas peças ou copys caso o cliente tenha solicitado na etapa de aprovação.",
        columnId: "col-s3",
        priority: "medium",
        assigneeRule: { type: "role", value: "Designer", fallback: "manager" },
        relativeDueDate: {
      ...
      },
      {
        ...
        description:
          "Programar posts aprovados no painel de agendamento (Mlabs ou Estúdio de Criação).",
        columnId: "col-s6",
        priority: "high",
        assigneeRule: { type: "role", value: "Social Media", fallback: "manager" },
        relativeDueDate: {
