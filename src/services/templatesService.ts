...
import { AgencyTemplate, TemplateColumn, TemplateTask, TemplateChecklistItem } from '../data/templateTypes';
...
export async function simulateTemplateApplication(templateId: string, context: TemplateApplyContext) {
