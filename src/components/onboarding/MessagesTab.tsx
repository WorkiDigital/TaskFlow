    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between mb-2">
        <p className="text-sm text-muted-foreground">
          {messages.length} mensagem{messages.length !== 1 ? "s" : ""} configurável
          {messages.length !== 1 ? "s" : ""}
        </p>
    ...
    >
      ...
      {expanded && (
        <div className="px-4 pb-4 space-y-3 border-t border-border/50 pt-3">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="outline"
                  size="sm"
                  className="h-7 gap-1.5 text-xs border-border hover:border-primary/50 hover:bg-primary/5"
                >
              ...
              <DropdownMenuContent
                className="bg-popover border-border w-64 max-h-72 overflow-y-auto"
                align="start"
              >
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="outline"
                  size="sm"
                  className="h-7 gap-1.5 text-xs border-border hover:border-primary/50"
                >
                  😊 Emoji
                </Button>
              </DropdownMenuTrigger>
          ...
          {/* Editor + preview */}
          <div
            className={cn("grid gap-3", showPreview ? "grid-cols-1 lg:grid-cols-2" : "grid-cols-1")}
          >
            {/* Textarea */}
