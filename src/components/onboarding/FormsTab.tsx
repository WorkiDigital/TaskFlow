...
export function FormsTab({
  ...
  const createNew = () => {
    const newForm: FormTemplate = {
      ...
      name:
        newName.trim() ||
        `Novo ${newType === "contractual" ? "Formulário Contratual" : "Briefing"}`,
      type: newType,
      fields: [],
      isDefault: false,
    ...
    <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-4 min-h-[600px]">
      ...
      <div className="flex flex-col gap-2">
        ...
        {contractualForms.length > 0 && (
          <div>
            <p className="text-[10px] uppercase tracking-widest text-muted-foreground px-2 py-2 font-semibold">
              Contratuais
            </p>
      ...
      <div className="glass-card p-5 flex flex-col">
        {!selectedForm ? (
          ...
          <>
            ...
            <div className="flex items-center gap-2 mb-4 pb-4 border-b border-border">
              ...
              <div className="flex gap-1">
                ...
                <Button
                  ...
                  className={cn(
                    "h-8 gap-1.5 text-xs",
                    viewMode === "edit" && "bg-white/10 text-foreground",
                  )}
                >
                ...
                <Button
                  ...
                  className={cn(
                    "h-8 gap-1.5 text-xs",
                    viewMode === "preview" && "bg-white/10 text-foreground",
                  )}
                >
            ...
            {/* Conteúdo */}
            {viewMode === "edit" ? (
              <FormBuilder form={selectedForm} variables={variables} onSave={onSave} />
            ) : (
      ...
      <Dialog open={showNewDialog} onOpenChange={setShowNewDialog}>
        <DialogContent className="bg-popover border-border sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Crie um novo modelo de formulário para o onboarding.
            </DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={!!deleteConfirmId} onOpenChange={(open) => !open && setDeleteConfirmId(null)}>
        <DialogContent className="bg-popover border-border sm:max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription>
              Esta ação não pode ser desfeita. O formulário e todos os seus campos serão removidos
              permanentemente.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
              ...
              onClick={() => {
                if (deleteConfirmId) {
                  ...
                  if (selectedId === deleteConfirmId)
                    setSelectedId(templates.find((t) => t.id !== deleteConfirmId)?.id ?? null);
      ...
      >
        ...
        {!form.isDefault && (
          <button
            ...
            className="p-1 rounded hover:bg-white/10 text-muted-foreground hover:text-warning"
          >
