...
const modes: ModeOption[] = [
  {
    ...
    description:
      "Ativa todas as etapas de onboarding: formulários, contratos, WhatsApp e briefing.",
    icon: Copy,
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Escolha um template base. Isso vai pré-configurar quais etapas estarão ativas.
        </p>
      </div>
        ...
        {modes.map((mode) => {
          ...
          return (
            ...
            >
              ...
              <div
                className={cn(
                  "w-10 h-10 rounded-lg flex items-center justify-center border mb-3",
                  mode.color,
                )}
              >
