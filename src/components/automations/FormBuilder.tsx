        ...
        <div className="flex-1 p-6 overflow-y-auto border-r border-white/5 flex flex-col gap-6">
          <div className="flex items-center justify-between">
            ...
            <Button
              onClick={addField}
              size="sm"
              className="gap-2 bg-white/10 hover:bg-white/20 text-foreground"
            >
          ...
          {editingField ? (
            <div className="space-y-6 animate-in fade-in slide-in-from-right-2">
              ...
              <div className="space-y-2 pt-2">
                ...
                <p className="text-[10px] text-muted-foreground mb-2 leading-relaxed">
                  A resposta deste campo será salva nesta variável para você usar em contratos e
            ...
            <div className="flex-1 flex items-center justify-center text-center">
              <p className="text-sm text-muted-foreground">
                Selecione um campo ao lado para editar suas propriedades.
              </p>
            </div>
          )}
        </div>
            ...
            {fields.map((field) => (
              <div key={field.id} className="space-y-1.5 opacity-80 pointer-events-none">
                ...
                {field.type === "long_text" ? (
                  <Textarea
                    className="min-h-[60px] bg-zinc-50 dark:bg-zinc-950 border-zinc-200 dark:border-zinc-800"
                  ...
                  <Input
                    className="h-8 bg-zinc-50 dark:bg-zinc-950 border-zinc-200 dark:border-zinc-800 text-xs"
                    placeholder={field.type === "email" ? "exemplo@email.com" : "Sua resposta..."}
                  />
                )}
              </div>
            ))}
