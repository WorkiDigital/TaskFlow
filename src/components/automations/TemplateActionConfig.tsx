...
export function TemplateActionConfig({
  initialConfig,
  onSave,
  onCancel,
}: TemplateActionConfigProps) {
    ...
    <div className="flex flex-col h-full bg-background">
      <div className="shrink-0 p-6 border-b border-white/5 bg-black/20">
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Cria automaticamente projeto, tarefas e responsáveis baseados em um modelo.
        </p>
      </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="space-y-2">
            ...
            <p className="text-[10px] text-muted-foreground">
              Use variáveis como {"{{nome_cliente}}"}
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4 pt-4 border-t border-border/40">
          ...
          <label className="flex items-start gap-3 cursor-pointer group">
            ...
            <div className="space-y-1">
              <p className="text-sm font-medium leading-none group-hover:text-primary transition-colors">
                Notificar grupo interno
              </p>
              <p className="text-xs text-muted-foreground">
                Envia uma mensagem no grupo do WhatsApp da agência quando o projeto for criado.
              </p>
            </div>
          </label>
          ...
          <label className="flex items-start gap-3 cursor-pointer group">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground">
                O projeto nasce pausado e o gestor precisa aprovar a criação antes de notificar
                clientes.
              </p>
            </div>
          </label>
